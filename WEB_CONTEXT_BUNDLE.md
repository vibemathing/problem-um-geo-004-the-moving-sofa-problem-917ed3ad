...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-geo-004-the-moving-sofa-problem-917ed3ad-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GEO-004"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-geo-004-the-moving-sofa-problem-917ed3ad-v1",
      "problem_contract_sha256": "a64f4cc34df17e62e2d14d37d3c8c461017f5f4208d5b7d4aa1cf7ef2eb606f6",
      "problem_id": "problem:um-geo-004-the-moving-sofa-problem-917ed3ad",
      "route_id": "route:um-geo-004-the-moving-sofa-problem-917ed3ad-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-geo-004-the-moving-sofa-problem-917ed3ad-source-fidelity-01",
      "graph_id": "graph:um-geo-004-the-moving-sofa-problem-917ed3ad-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-geo-004-the-moving-sofa-problem-917ed3ad-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-geo-004-the-moving-sofa-problem-917ed3ad-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the largest area of a shape that can be maneuvered through an L-shaped corridor of unit width?"
          },
          "statement_sha256": "e6c6a3fa4e1d3e27a5df77f2e87ae98a5c9c29145586f331c4717eb5f28287fb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-geo-004-the-moving-sofa-problem-917ed3ad-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-geo-004-the-moving-sofa-problem-917ed3ad-root",
      "route_id": "route:um-geo-004-the-moving-sofa-problem-917ed3ad-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-geo-004-a7d267d5d143",
        "url": "https://www.unsolvedmath.com/problems/GEO-004"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
